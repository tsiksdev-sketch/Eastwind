...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 left-6 z-50 grid place-items-center rounded-full bg-background/80 backdrop-blur-md shadow-soft border border-border transition-all duration-300 hover:scale-110 ${
